...
export default function PartiesPage() {
  ...
  }, [searchTerm, filterType, currentPage, setSearchParams]);
          ...
          <div className="flex gap-4 items-end">
            <div className="flex-1">
              <Input
                ...
                onKeyDown={(e) => { if (e.key === 'Enter') { setSearchTerm(pendingSearchTerm); setFilterType(pendingFilterType); } }}
              />
            </div>
            ...
            <Button variant="outline" size="sm" onClick={() => { setPendingSearchTerm(''); setPendingFilterType('all'); setSearchTerm(''); setFilterType('all'); }} data-testid="clear-filters-btn">Clear</Button>
            <Button size="sm" onClick={() => { setSearchTerm(pendingSearchTerm); setFilterType(pendingFilterType); }} data-testid="apply-filters-btn">Apply Filters</Button>
          </div>
        </CardContent>
      </Card>
