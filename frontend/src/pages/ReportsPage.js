...
export default function ReportsPage() {
  ...
  // Filter states for transactions tab - pending (UI) and applied (API)
  ...
  const [pendingReturnsFilters, setPendingReturnsFilters] = useState({
    date_from: '',
    date_to: '',
    return_type: '',
    status: '',
  ...
  const clearFilters = () => {
    const empty = { account_id: '', account_type: '', transaction_type: '', reference_type: '', start_date: '', end_date: '' };
  ...
  const clearReturnsFilters = () => {
    const empty = { date_from: '', date_to: '', return_type: '', status: '', refund_mode: '', party_id: '', search: '' };
    setPendingReturnsFilters(empty);
    setReturnsFilters(empty);
  };

  const applyReportsReturnsFilters = () => {
    setReturnsFilters({ ...pendingReturnsFilters });
  };
              ...
              <div className="px-6 pb-4 border-b bg-muted/30">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Select value={pendingFilters.account_id} onValueChange={(val) => setPendingFilters({...pendingFilters, account_id: val})}>
                  ...
                  <div>
                    ...
                    <Select value={pendingFilters.transaction_type} onValueChange={(val) => setPendingFilters({...pendingFilters, transaction_type: val})}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div>
                    ...
                    <Select value={pendingFilters.reference_type} onValueChange={(val) => setPendingFilters({...pendingFilters, reference_type: val})}>
                      <SelectTrigger className="mt-1">
                ...
                <div className="mt-3 flex justify-end gap-2">
                  ...
                  <Button size="sm" onClick={applyReportsFilters} data-testid="apply-filters-btn">
                    Apply Filters
                  </Button>
                </div>
              </div>
          ...
          <Card>
            ...
            {showReturnsFilters && (
              <div className="px-6 pb-4 border-b bg-muted/30">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      type="date"
                      className="mt-1"
                      value={pendingReturnsFilters.date_from}
                      onChange={(e) => setPendingReturnsFilters({...pendingReturnsFilters, date_from: e.target.value})}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      type="date"
                      className="mt-1"
                      value={pendingReturnsFilters.date_to}
                      onChange={(e) => setPendingReturnsFilters({...pendingReturnsFilters, date_to: e.target.value})}
                    />
                  </div>
                  
                  <div>
                    <Label className="text-xs">Return Type</Label>
                    <Select value={pendingReturnsFilters.return_type} onValueChange={(val) => setPendingReturnsFilters({...pendingReturnsFilters, return_type: val})}>
                      <SelectTrigger className="mt-1">
                        <SelectValue placeholder="All Types" />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div>
                    ...
                    <Select value={pendingReturnsFilters.status} onValueChange={(val) => setPendingReturnsFilters({...pendingReturnsFilters, status: val})}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div>
                    ...
                    <Select value={pendingReturnsFilters.refund_mode} onValueChange={(val) => setPendingReturnsFilters({...pendingReturnsFilters, refund_mode: val})}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div>
                    ...
                    <Select value={pendingReturnsFilters.party_id} onValueChange={(val) => setPendingReturnsFilters({...pendingReturnsFilters, party_id: val})}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div className="md:col-span-3">
                    ...
                    <Input
                      type="text"
                      className="mt-1"
                      value={pendingReturnsFilters.search}
                      onChange={(e) => setPendingReturnsFilters({...pendingReturnsFilters, search: e.target.value})}
                      onKeyDown={(e) => { if (e.key === 'Enter') applyReportsReturnsFilters(); }}
                ...
                <div className="mt-3 flex justify-end gap-2">
                  {hasActiveReturnsFilters && (
                    <Button variant="ghost" size="sm" onClick={clearReturnsFilters} data-testid="clear-returns-filters-btn">
                      <X className="w-4 h-4 mr-2" /> Clear Filters
                    </Button>
                  )}
                  <Button size="sm" onClick={applyReportsReturnsFilters} data-testid="apply-returns-filters-btn">
                    Apply Filters
                  </Button>
                </div>
              </div>
